...
def ven():
    st.title("Max winning Places")
    choice = ['Chennai Super Kings', 'Hyderabad Sunriser', 'Delhi Capitals', 'Gujarat Lions', 'Kings XI Punjab', 'Kochi Tuskers Kerala', 'Kolkata Knight Riders', 'Mumbai Indians', 'Pune Warriors', 'Rajasthan Royals', 'Pune Supergiant', 'Royal Challengers Bangalore']
    choice_selected = st.sidebar.selectbox("Select choice", choice)
    venue(choice_selected)